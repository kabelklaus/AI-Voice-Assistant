...
from operations.user_db_chroma_operations import *

# Sprache
# from skills.t2s_deepgram_skill import spreche_text # nur Englisch
# from skills.t2s_elevenlabs_skill import spreche_text
from skills.t2s_openai_skill import spreche_text
...
# Initialize Chroma for chat memory
vector_db = initialize_vector_db(
    embeddings,
    persist_directory="./chroma_db"
)

# Initialize Chroma for user information
...
function_calls = {
    ...
    "save_user_info": lambda *args: save_user_info(user_db, *args),
    "get_user_info": lambda *args: get_user_info(user_db, *args),
}
...
def chat(user_input):
    ...
    user_info = retrieve_all_user_info(user_db, user_id)
    
    # Format past information, conversation history, and user information
    context = "Conversation history:\n"
    for message in conversation_history[-10:]:  # Include last 10 messages for context
